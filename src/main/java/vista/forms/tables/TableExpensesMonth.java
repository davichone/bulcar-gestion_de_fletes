 ...
 * @author drola
 */
public class TableExpensesMonth extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TableExpensesMonth.class.getName());
     ...
     */
    public TableExpensesMonth(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        injectTable();
        injectData();
    ...
    private void injectTable() {
        ...
        try {
            ...
            List<Expense> listaSolicitudes = controllExpense.getlist();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Egresos Mensuales");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TableExpensesMonth dialog = new TableExpensesMonth(new javax.swing.JFrame(), true);
